...
class DataMapper implements IteratorAggregate {
	 ...
	 * Filter By
	 *
	 * Sets the filtering portion of the query.
	 *
	 * @param	string $filterby text to filter by
	 * @param	array $fields Columns to filter/search in
	 * @return	DataMapper Returns self for method chaining.
	 */
	public function filter_by($filterby, $fields = array())
	{
	    $this->db->like('id', '');
		foreach($fields as $field){
		    $this->db->or_like($field, $filterby, 'both');
		}
